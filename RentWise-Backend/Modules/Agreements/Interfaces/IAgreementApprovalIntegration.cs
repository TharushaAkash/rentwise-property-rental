...
public interface IAgreementApprovalIntegration
{
    ...
    Task<string> RequireOwnerAsync(int agreementId, int provisionalOwnerId, CancellationToken cancellationToken);
...
public sealed record AgreementApprovalAudit(int AgreementId, string ReviewerUserId,
